...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-dch5ine.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-dch5ine.containers.anotherwebservice.com/
...
```
git clone git@github.com:sophakabuso/container-dch5ine.git
cd container-dch5ine
```
...
```
docker attach container-dch5ine
```
